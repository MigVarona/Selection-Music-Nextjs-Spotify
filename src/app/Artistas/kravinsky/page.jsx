        ...
        <div className="flex flex-col items-center mx-auto max-w-7xl lg:flex-row mt-20 lg:mt-35">
          ...
          <div className="flex flex-col items-center mt-12 lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 ">
            ...
            <p className="mb-8 text-base leading-relaxed text-gray-500 text-center lg:text-left">
              Tras varios años de actor, la carrera musical de Kavinsky comienza
              en el 2005 tras ser inspirado por sus amigos Jackson Fourgeaud y
              Quentin Dupieux. Este último, director de cine, incluye obras de
              Kavinsky en su filme Steak. Durante este periodo, Kavinsky produce
              su primer sencillo, Testarossa Autodrive, inspirado en el
              deportivo italiano de los Años 80 Ferrari Testarossa.{" "}
            </p>
