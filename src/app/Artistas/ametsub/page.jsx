          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:max-w-lg lg:mr-8">
            <div className="relative w-full max-w-lg mx-auto ">
              ...
              <Image 
                ...
                width={900}
                height={600} alt="hero" src="/Artistas/Amtsub.jpg" />
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center mt-12 lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 ">
            <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl text-center lg:text-left">AMETSUB</h1>
            <p className="mb-8 text-base leading-relaxed text-gray-500 text-center lg:text-left">Ametsub es el nombre artístico del músico japonés Yu Miyashita, reconocido por sus contribuciones a la música electrónica ambiental y experimental.</p>
