            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 lg:max-w-lg lg:mr-8">
              <div className="relative w-full max-w-lg mx-auto ">
                ...
                <div className="relative">
                  <img className="object-cover object-center w-full h-full mx-auto rounded-lg shadow-2xl" alt="hero" src="/Discos/Daftpunk-homework.jpg" />
                </div>
              </div>
            </div>
            <div className="flex flex-col items-center mt-12 lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 ">
              <h1 className="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl text-center lg:text-left">DAFT PUNK</h1>
              <p className="mb-8 text-base leading-relaxed text-gray-500 text-center lg:text-left">Daft Punk fue un dúo musical francés de música electrónica formado por Guy-Manuel de Homem-Christo y Thomas Bangalter. Se hicieron famosos a mediados de la década de 1990 y se convirtieron en una de las figuras más influyentes en la escena de la música electrónica y pop.</p>
              <div className="mt-0 lg:mt-6 w-full max-w-3xl mx-auto sm:flex justify-center">
                <div className="mt-3 rounded-lg sm:mt-0">
                  <iframe
                    style={{ borderRadius: '12px' }}
                    src="https://open.spotify.com/embed/album/5uRdvUR7xCnHmUW8n64n9y?utm_source=generator&theme=0"
                    width="100%"
                    height="152"
                    frameBorder="0"
                    allowfullscreen=""
