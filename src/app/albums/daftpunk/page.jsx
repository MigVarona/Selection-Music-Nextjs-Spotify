        ...
        <div className="flex flex-col items-center mx-auto max-w-7xl lg:flex-row mt-20 lg:mt-35">
            ...
            <div className="relative w-full max-w-lg mx-auto ">
              ...
              <div className="relative">
                <Image
                  ...
                  height={600}
                  alt="hero"
                  src="/Discos/Daftpunk-homework.jpg"
                />
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center mt-12 lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 ">
            ...
            <p className="mb-8 text-base leading-relaxed text-gray-500 text-center lg:text-left">
              Daft Punk fue un dúo musical francés de música electrónica formado
              por Guy-Manuel de Homem-Christo y Thomas Bangalter. Se hicieron
              famosos a mediados de la década de 1990 y se convirtieron en una
              de las figuras más influyentes en la escena de la música
              electrónica y pop.
            </p>
