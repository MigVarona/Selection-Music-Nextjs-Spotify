        ...
        <div className="flex flex-col items-center mx-auto max-w-7xl lg:flex-row mt-20 lg:mt-35">
            ...
            <div className="relative w-full max-w-lg mx-auto ">
              ...
              <div className="relative">
                <Image
                  ...
                  height={600}
                  alt="hero"
                  src="/Discos/Yaeji-With a Hammer.jpg"
                />
              </div>
            </div>
          </div>
          <div className="flex flex-col items-center mt-12 lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 ">
            ...
            <p className="mb-8 text-base leading-relaxed text-gray-500 text-center lg:text-left">
              Yaeji, cuyo nombre real es Kathy Yaeji Lee, es una productora y DJ
              de música electrónica nacida en Nueva York con raíces en Corea del
              Sur. Su enfoque musical distintivo fusiona elementos de house,
              techno y hip hop, y ha ganado reconocimiento por su estilo
              ecléctico y su habilidad para crear pistas envolventes.{" "}
            </p>
