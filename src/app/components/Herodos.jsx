  ...
  return (
    ...
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <div className="mb-10 md:mb-16 ">
        ...
        <p className="mx-auto max-w-screen-md text-center text-gray-500 md:text-lg">Join us in celebrating the diversity of talent and the richness of melodies.</p>
      </div>
